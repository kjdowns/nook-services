    ...
    render(){
        return(
            <div className="turnip-page">
                ...
                <div id="turnip-header">
                    <img alt="Diasy Mae" src="https://vignette.wikia.nocookie.net/animalcrossing/images/8/85/Daisy_Mae.png/revision/latest?cb=20200220213944" />
                    <div>
                        <p>
                ...
                <div className="spike-wrapper">
                    <TurnipSpike className="turnip-spike" type={"Decreasing"} url={"https://i0.wp.com/nintygamer.com/wp-content/uploads/2020/04/acnh-turnip-prices-decreasing.png?resize=768%2C327&ssl=1"} />
                    <div className="spike-text">
                        <p>
                ...
                <div className="spike-wrapper">
                    <TurnipSpike className="turnip-spike" type={"Small Spike"} url={"https://i0.wp.com/nintygamer.com/wp-content/uploads/2020/04/acnh-turnip-prices-camel-hump.png?resize=768%2C328&ssl=1"} />
                    <div className="spike-text">
                        <p>
                ...
                <div className="spike-wrapper">
                    <TurnipSpike className="turnip-spike" type={"Large Spike"} url={"https://i1.wp.com/nintygamer.com/wp-content/uploads/2020/04/acnh-turnip-prices-big-spike.png?resize=768%2C330&ssl=1"} />
                    <div className="spike-text">
                        <p>
