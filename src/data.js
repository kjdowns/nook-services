...
export const pansies = [
    flowerIcons.pansies.red,
    flowerIcons.pansies.yellow,
    flowerIcons.pansies.white,
    flowerIcons.pansies.orange,
    flowerIcons.pansies.purple,
...
export const mums = [
    flowerIcons.mums.red,
    flowerIcons.mums.yellow,
    flowerIcons.mums.white,
    flowerIcons.mums.pink,
    flowerIcons.mums.purple,
    flowerIcons.mums.green
]
